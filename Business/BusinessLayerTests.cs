...
namespace Phumla_Kamnandi_GRP_12.Business
{
    public class BusinessLayerTests
    {
        ...
        private static void TestPricingService()
        {
            ...
            // Test total calculation with single occupancy (2 nights at R550 + 50% = R825 per night)
            ...
            // Test with family - room rate doesn't change with children in same room
            decimal familyTotal = pricingService.CalculateTotalAmount(
                new DateTime(2025, 12, 5), new DateTime(2025, 12, 7), 2, 1, 2, false);
            AssertEqual(1100m, familyTotal, "Family booking for 2 nights at R550 per room");
        ...
        private static void TestBookingService()
        {
            ...
            // Test making a booking for December 24-25 (1 night in high season)
            ...
            AssertEqual(995m, result1.TotalAmount, "High season rate R995 for one night");
